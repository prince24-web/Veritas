...
import { Send, Mic, Plus, BookOpen } from 'lucide-react';
...
export default function Chat() {
  ...
  // Only scroll on new user message or start of AI response, not every chunk
  // We handle initial scroll in submit handler. 
  // For AI streaming, we can let the user scroll if they want, or auto-scroll if they are at the bottom.
  // For now, let's keep it simple: don't force scroll on every update to allow reading back.
